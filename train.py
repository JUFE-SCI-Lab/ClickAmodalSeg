...
def parse_args():
    ...
    parser.add_argument('--exp-name', type=str, default='plainvit_base448_d2sa_itermask_prevMod',
                        help='Here you can specify the name of the experiment. '
                             'It will be added as a suffix to the experiment folder.')
    
    parser.add_argument('--dataset', type=str, default="COCOA", help = "select dataset")

    parser.add_argument('--path', type=str, default="/home/univ/hongren/Projects/Amodal_Interactive_Segmentation/config", )
    parser.add_argument('--log_path', type=str, default="/home/univ/hongren/Projects/Amodal_Interactive_Segmentation/logs", )
